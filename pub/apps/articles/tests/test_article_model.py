...
class ArticleModelTest(TestCase):
    ...
    def test_slug_is_generated_on_save(self):
        """Test that the slug is generated from the title when saving an article."""  # noqa: E501
    ...
    def test_unpublished_article_fields(self):
        """Test that an unpublished article has is_published=False and published_at=None."""  # noqa: E501
        self.unpublished_article.save()
    ...
    def test_published_article_fields(self):
        """Test that a published article has is_published=True and published_at set."""  # noqa: E501
