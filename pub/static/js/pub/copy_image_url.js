  ...
  if (window.location.pathname.includes("/change/")) {
    setTimeout(function () {
      ...
      if (uploadLabel) {
        ...
        copyBtn.className =
          "cursor-pointer text-base-400 px-3 hover:text-base-700 dark:text-base-500 dark:hover:text-base-200 border-r border-base-200 dark:border-base-700 p-1";

        copyBtn.title = "Copy image URL";
        copyBtn.innerHTML =
          '<span class="block material-symbols-outlined">content_copy</span>';
